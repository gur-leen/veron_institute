...
const ContactUs = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="min-h-screen bg-gradient-to-r from-[#ff69b4] to-[#ffb347] flex flex-col justify-center items-center">
                <motion.div
                ...
                >
                    <div className="w-full max-w-4xl bg-white/10 backdrop-blur-lg p-10 rounded-xl shadow-lg border border-white/20 mt-30">
                        <motion.h1
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full px-4 py-2 bg-white border border-gray-400 rounded-lg focus:ring-2 focus:ring-pink-500"
                                    />
                                </div>
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="w-full bg-[#ff69b4] hover:bg-[#ff7e99] text-white py-2 px-4 rounded-lg font-bold text-lg transition-all"
                                >
                                    Send Message
                                </motion.button>
                            </motion.form>
