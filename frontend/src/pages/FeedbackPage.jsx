    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-r from-[#ff69b4] to-[#ffb347] flex flex-col justify-center items-center">
                ...
                >
                    <div className="w-full max-w-2xl bg-white/10 backdrop-blur-lg p-10 rounded-xl shadow-lg border border-white/20 mt-30">
                        <motion.h1
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="w-full bg-[#ff69b4] hover:bg-[#ffb347] text-white py-2 px-4 rounded-lg font-bold text-lg transition-all disabled:opacity-50"
                                type="submit"
                                disabled={isSubmitting}
                            >
